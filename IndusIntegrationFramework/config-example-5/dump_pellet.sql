...
insert into `ds1_synonyms`(`Person`,`Name`,`Entry`,`PublishedOn`,`Organization`,`Address`,`ISBN`) values ('Neeraj','Ontology','NonFormal','2009-10-07 00:00:00','University','KSU','110');
